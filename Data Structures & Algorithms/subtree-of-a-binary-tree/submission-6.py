"""
KEY INSIGHTS
USE THE SAME CODE AS SAME BINARY TREE
WE JUST CALL NOW CALL IT WHEVER WE HIT ==SUBROOT.VAL
SEE MORE COMMENTS BELOW
        if subRoot is None: return True //// AN EMPTY SUBTREE IS A SUBTREE
        if root is None: return False //// NOT A SUBTREE
